...
var path = require('path');  // imports path module from node.js, sue dfo rhandling aand transforming file paths.Useful for work with directories and files in a platform independent way
...
var hbs = require('express-handlebars'); // imorts express handlebars module, templating engine used with Express.Allows dynmaically generate HTML views injecting data to predefined templates(views)
